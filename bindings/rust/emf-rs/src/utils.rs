...
extern "C" {
	...
	pub(crate) fn send_message(sender_id: String, target_id: String, message: String);
	...
	///
	/// Returns the patch.
	pub(crate) fn patch_new(address: u64, data: Vec<u8>) -> Box<PatchRaw>;
	...
	/// Returns the patch.
	#[allow(unused)]
	pub(crate) fn patch_from_signature(signature: String, data: Vec<u8>) -> Option<Box<PatchRaw>>;
	...
	#[allow(unused)]
	pub(crate) fn patch_offset_pointer(patch: &mut PatchRaw, offset: isize) -> *const u8;
	...
	pub(crate) fn patch_apply(patch: &mut PatchRaw) -> bool;
	...
	pub(crate) fn patch_revert(patch: &mut PatchRaw) -> bool;
	...
	pub(crate) fn patch_is_applied(patch: &PatchRaw) -> bool;
	...
	#[allow(unused)]
	pub(crate) fn patch_read_current(patch: &PatchRaw) -> Option<Box<Vec<u8>>>;
	...
	pub(crate) fn reassemble_instruction_at_offset(bytes: Vec<u8>, offset: usize) -> Vec<u8>;
	...
	/// Returns the offset pointer.
	#[allow(unused)]
	pub(crate) fn hook_offset_pointer(hook: &mut HookRaw, offset: isize) -> *mut *mut c_void;
	...
	pub(crate) fn hook_apply(hook: &mut HookRaw) -> bool;
	...
	pub(crate) fn hook_revert(hook: &mut HookRaw) -> bool;
